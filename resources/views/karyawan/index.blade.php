        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form method="GET" action="{{ url('/karyawan') }}" class="d-flex" style="width: 280px;" id="searchForm">
                    ...
                    <button type="submit" class="btn btn-outline-light border-start-0"><i
                        ...
                        <tbody id="karyawanTbody">
                            @forelse($karyawans as $kar)
                                <tr>
                                    ...
                                    <td>{{ $kar->kar_hp ?? '-' }}</td>
                                    <td><span class="badge badge-success">{{ $kar->golongan->golongan_nama ?? '-' }}</span>
                                    </td>
                                    <td><span class="badge badge-warning">{{ $kar->jabatan->jabatan_nama ?? '-' }}</span>
                                    </td>
                    ...
                    <div id="detailContent" class="d-none">
                        <table class="table table-borderless table-striped">
                            <tbody>
                                <tr>
                                    <th>Kode</th>
                                    <td id="detail_kar_kode"></td>
                                </tr>
                                <tr>
                                    <th>NIP</th>
                                    <td id="detail_kar_nip"></td>
                                </tr>
                                <tr>
                                    <th>NIK</th>
                                    <td id="detail_kar_nik"></td>
                                </tr>
                                <tr>
                                    <th>Nama</th>
                                    <td id="detail_kar_nama"></td>
                                </tr>
                                <tr>
                                    <th>Gelar Depan</th>
                                    <td id="detail_kar_gelar_depan"></td>
                                </tr>
                                <tr>
                                    <th>Gelar Belakang</th>
                                    <td id="detail_kar_gelar_belakang"></td>
                                </tr>
                                <tr>
                                    <th>Tempat Lahir</th>
                                    <td id="detail_kar_lahir_tmp"></td>
                                </tr>
                                <tr>
                                    <th>Tanggal Lahir</th>
                                    <td id="detail_kar_lahir_tgl"></td>
                                </tr>
                                <tr>
                                    <th>Jenis Kelamin</th>
                                    <td id="detail_kar_jekel"></td>
                                </tr>
                                <tr>
                                    <th>Alamat</th>
                                    <td id="detail_kar_alamat"></td>
                                </tr>
                                <tr>
                                    <th>Email</th>
                                    <td id="detail_kar_email"></td>
                                </tr>
                                <tr>
                                    <th>Email Perusahaan</th>
                                    <td id="detail_kar_email_perusahaan"></td>
                                </tr>
                                <tr>
                                    <th>No HP</th>
                                    <td id="detail_kar_hp"></td>
                                </tr>
                                <tr>
                                    <th>WA</th>
                                    <td id="detail_kar_wa"></td>
                                </tr>
                                <tr>
                                    <th>Telegram</th>
                                    <td id="detail_kar_telegram"></td>
                                </tr>
                                <tr>
                                    <th>No Rekening</th>
                                    <td id="detail_kar_norek"></td>
                                </tr>
                                <tr>
                                    <th>No BPJS</th>
                                    <td id="detail_kar_nobpjs"></td>
                                </tr>
                                <tr>
                                    <th>No Jamsostek</th>
                                    <td id="detail_kar_nojamsostek"></td>
                                </tr>
                                <tr>
                                    <th>NPWP</th>
                                    <td id="detail_kar_npwp"></td>
                                </tr>
                                <tr>
                                    <th>Agama</th>
            ...
            karyawanDetailModal.addEventListener('show.bs.modal', function(event) {
                ...
                fetch(`{{ $apiBase ?? 'http://127.0.0.1:8000/api' }}/karyawan/${kar_kode}`, {
                    ...
                    .then(data => {
                        ...
                        document.getElementById('detail_kar_gelar_depan').innerText = kar
                            .kar_gelar_depan || '-';
                        document.getElementById('detail_kar_gelar_belakang').innerText = kar
                            .kar_gelar_belakang || '-';
                        ...
                        document.getElementById('detail_kar_email_perusahaan').innerText = kar
                            .kar_email_perusahaan || '-';
                        ...
                        document.getElementById('detail_kar_nojamsostek').innerText = kar
                            .kar_nojamsostek || '-';
                        ...
                        '-';
                        document.getElementById('detail_profesi').innerText = kar.profesi
                            ?.profesi_nama || '-';
                        ...
                        document.getElementById('detail_jabatan').innerText = kar.jabatan
                            ?.jabatan_nama || '-';
                        document.getElementById('detail_golongan').innerText = kar.golongan
                            ?.golongan_nama || '-';
            ...
            <nav>
                <ul class="pagination mb-0">
                    <li class="page-item {{ !$links['prev'] ? 'disabled' : '' }}">
                        <a class="page-link"
                            href="{{ $links['prev'] ? '?page=' . ($meta['current_page'] - 1) : '#' }}">«</a>
                    </li>
                    ...
                    <li class="page-item {{ !$links['next'] ? 'disabled' : '' }}">
                        <a class="page-link"
                            href="{{ $links['next'] ? '?page=' . ($meta['current_page'] + 1) : '#' }}">»</a>
                    </li>
                </ul>
            </nav>
        </div>
