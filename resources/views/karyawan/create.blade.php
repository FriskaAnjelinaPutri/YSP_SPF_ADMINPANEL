            ...
            <form action="{{ route('karyawan.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="kar_nama" name="kar_nama" value="{{ old('kar_nama') }}" required>
                    </div>
                    <div class="col-md-3">
                        <label for="kar_gelar_depan" class="form-label fw-semibold">Gelar Depan</label>
                        <input type="text" class="form-control" id="kar_gelar_depan" name="kar_gelar_depan" value="{{ old('kar_gelar_depan') }}">
                    </div>
                    <div class="col-md-3">
                        <label for="kar_gelar_belakang" class="form-label fw-semibold">Gelar Belakang</label>
                        <input type="text" class="form-control" id="kar_gelar_belakang" name="kar_gelar_belakang" value="{{ old('kar_gelar_belakang') }}">
                    </div>

                    {{-- Tempat & Tanggal Lahir --}}
                    <div class="col-md-6">
                        <label for="kar_lahir_tmp" class="form-label fw-semibold">Tempat Lahir</label>
                        <input type="text" class="form-control" id="kar_lahir_tmp" name="kar_lahir_tmp" value="{{ old('kar_lahir_tmp') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="kar_lahir_tgl" class="form-label fw-semibold">Tanggal Lahir</label>
                        <input type="date" class="form-control" id="kar_lahir_tgl" name="kar_lahir_tgl" value="{{ old('kar_lahir_tgl') }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="kar_alamat" name="kar_alamat" value="{{ old('kar_alamat') }}">
                    </div>

                    {{-- Email & HP --}}
                    <div class="col-md-6">
                        <label for="kar_email" class="form-label fw-semibold">Email</label>
                        <input type="email" class="form-control" id="kar_email" name="kar_email" value="{{ old('kar_email') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="kar_email_perusahaan" class="form-label fw-semibold">Email Perusahaan</label>
                        <input type="email" class="form-control" id="kar_email_perusahaan" name="kar_email_perusahaan" value="{{ old('kar_email_perusahaan') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="kar_hp" class="form-label fw-semibold">No HP</label>
                        <input type="text" class="form-control" id="kar_hp" name="kar_hp" value="{{ old('kar_hp') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="kar_wa" class="form-label fw-semibold">No WA</label>
                        <input type="text" class="form-control" id="kar_wa" name="kar_wa" value="{{ old('kar_wa') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="kar_telegram" class="form-label fw-semibold">Telegram</label>
                        <input type="text" class="form-control" id="kar_telegram" name="kar_telegram" value="{{ old('kar_telegram') }}">
                    </div>

                    {{-- Rekening, BPJS, Jamsostek, NPWP --}}
                    <div class="col-md-6">
                        <label for="kar_norek" class="form-label fw-semibold">No Rekening</label>
                        <input type="text" class="form-control" id="kar_norek" name="kar_norek" value="{{ old('kar_norek') }}">
                    </div>
                    <div class="col-md-4">
                        <label for="kar_nobpjs" class="form-label fw-semibold">No BPJS</label>
                        <input type="text" class="form-control" id="kar_nobpjs" name="kar_nobpjs" value="{{ old('kar_nobpjs') }}">
                    </div>
                    <div class="col-md-4">
                        <label for="kar_nojamsostek" class="form-label fw-semibold">No Jamsostek</label>
                        <input type="text" class="form-control" id="kar_nojamsostek" name="kar_nojamsostek" value="{{ old('kar_nojamsostek') }}">
                    </div>
                    <div class="col-md-4">
                        <label for="kar_npwp" class="form-label fw-semibold">NPWP</label>
                        <input type="text" class="form-control" id="kar_npwp" name="kar_npwp" value="{{ old('kar_npwp') }}">
                    </div>
