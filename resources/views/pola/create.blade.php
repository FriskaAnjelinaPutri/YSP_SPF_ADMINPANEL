...
<div class="container mx-auto py-6">
    <h1 class="text-2xl font-bold mb-6">Tambah Pola</h1>
    ...
    <form action="{{ route('pola.store') }}" method="POST" class="bg-white shadow-md rounded p-6">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="number" name="urut" id="urut" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
        </div>
